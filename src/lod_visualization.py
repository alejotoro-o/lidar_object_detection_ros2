    ...
    def update_plot(self, frame):
        ...
        if len(self.lidar_points) > 0:
            ...
            for obj, col in zip(self.objects.objects, colors):
                ...
                rect = matplotlib.patches.Rectangle((obj.l_shape.c1.x, obj.l_shape.c1.y), obj.l_shape.l1, obj.l_shape.l2, angle=np.rad2deg(obj.l_shape.theta), color = col, fill = False, lw=2)
